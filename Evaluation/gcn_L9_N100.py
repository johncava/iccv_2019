...
class Scinfaxi(nn.Module):
    ...
    def __init__(self):
        ...
        self.w6 = Variable(torch.randn(100,100).cuda(),requires_grad=True)
        self.w7 = Variable(torch.randn(100,100).cuda(),requires_grad=True)
        self.w8 = Variable(torch.randn(100,100).cuda(),requires_grad=True)
        self.w9 = Variable(torch.randn(100,1).cuda(),requires_grad=True)
...
for epoch in range(max_epochs):
    ...
    model_path = path + 'gcn-N_100-9_layer-epoch_'+str(epoch)+'.model'
